...
namespace VinylStore.DAL.DataAccess
{
    public class UserService : IUserService
    {
        ...
        public List<VinylMTO> GetMyCollection(string userId) //mettre cette methode dans collectionRepository (dabord dans l'interface)
        {
        ...
        public List<VinylMTO> GetMyWantlist(string userId)
        {
